...
@pytest.fixture
def character():
    return (CharacterCoreMechanics((10,15), 6, 1, {"Heal":(3,4,10), "Fire":(1,5,5), "Ice":(1,4,5), "Lightning":(1,5,5)}))
    
@pytest.fixture
def character_():
    return (CharacterCoreMechanics((50,70), 5, 1, {"Heal":(1,10,5), "Fire":(0,5,-5), "Ice": (0,5,5), "Lightning":(0,5,5)}))

@pytest.fixture
def test():
    return (CharacterCoreMechanics((4,70), 5, 1, {"Heal":(1,10,5), "Fire":(0,5,-5), "Ice": (0,5,5), "Lightning":(0,5,5)}))
